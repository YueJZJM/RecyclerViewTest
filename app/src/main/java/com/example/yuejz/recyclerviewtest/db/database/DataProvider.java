...
import com.example.yuejz.recyclerviewtest.MyApplication;
import com.example.yuejz.recyclerviewtest.db.ItemsDataHelper;

public class DataProvider extends ContentProvider {
    public static final Object obj = new Object();
    public static final String AUTHORITY = "com.example.yuejz.recyclerviewtest";
        ...
        private String matchTable (Uri uri){
            ...
            switch (sUriMATCHER.match(uri)) {
                case ALL_ITEMS://Demo列表
                    table = ItemsDataHelper.ItemDBInfo.TABLE_NAME;
                    break;
                default:
    ...
    public int bulkInsert(Uri uri, @NonNull ContentValues[] values) {
        ...
        public static void clearDBCache () {
            synchronized (DataProvider.obj) {
                ...
                db.delete(ItemsDataHelper.ItemDBInfo.TABLE_NAME, null, null);
            }
        }
        public static class DBHelper extends SQLiteOpenHelper {
            ...
            private void updateDb(SQLiteDatabase db, int version) {
                switch (version) {
                    case 1:
                        ItemsDataHelper.ItemDBInfo.TABLE.create(db);//Demo列表
                        break;
                }
            }
        }
